        ...
        <div className={styles.formWrapper}>
          <form className={styles.formContainer} onSubmit={submitHandler}>
            ...
            <div className={styles.submtiContainer}>
              <button className={styles.cancelBtn} onClick={modalCtx.showModalHandler}>Cancel post</button>
              <button className={styles.submitBtn} type="submit">Post Project</button>
            </div>
          </form>
        </div>
      </div>
