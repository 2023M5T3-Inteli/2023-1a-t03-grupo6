    ...
    <div className={styles.SideContent}>
        ...
        <div className={styles.MostLanguages}>
          <div className={styles.LanguagesIntro}>
            <span className={styles.LanguagesTittle}>Your most used languages</span>
            <span className={styles.LanguagesSubTittle}>Data based on your projects</span>
          </div>
          <div className={styles.LanguagesContent}>
            <div className={styles.NumberLanguage}>
              <div className={styles.InfoLanguage}>
                <span className={styles.LanguageName}>JavaScript<span className={styles.LangPercentage}><BsFillCircleFill className={styles.IconPercentage} size={11}/>45%</span></span>
                <span className={styles.DoneProjects}>12 done projects</span>
              </div>
            </div>
            <div className={styles.NumberLanguage}>
              <div className={styles.InfoLanguage}>
                <span className={styles.LanguageName}>TypesScript<span className={styles.LangPercentage}><BsFillCircleFill className={styles.IconPercentage} size={11}/>26%</span></span>
                <span className={styles.DoneProjects}>08 done projects</span>
              </div>
            </div>
            <div className={styles.NumberLanguage}>
              <div className={styles.InfoLanguage}>
                <span className={styles.LanguageName}>Python<span className={styles.LangPercentage}><BsFillCircleFill className={styles.IconPercentage} size={11}/>21%</span></span>
                <span className={styles.DoneProjects}>06 done projects</span>
              </div>
            </div>
            <div className={styles.NumberLanguage}>
              <div className={styles.InfoLanguage}>
                <span className={styles.LanguageName}>React Native<span className={styles.LangPercentage}><BsFillCircleFill className={styles.IconPercentage} size={11}/>08%</span></span>
