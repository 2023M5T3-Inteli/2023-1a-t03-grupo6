...
const EditProject = () => {
  const modalCtx = useContext(EditModalCtx);
  const { isLoading, error, sendRequest: editProject } = useHttp();
                    ...
                    >
                      <div className={styles.field}>
                        ...
                        <input
                          ...
                          placeholder="Tell us a new title"
                        />
                      </div>
                      <div className={styles.field}>
                      ...
                      <div className={styles.field}>
                        ...
                        <input
                          ...
                          placeholder="Tell us a new description."
                        />
                      </div>
                      <div className={styles.field}>
                        <label>Avaiable link:</label>
                        <input
                          placeholder="List a new link"
                        />
                      </div>
